...
model Example_SFH_FMU_UFH "Example model to simulate SFH with UFH"
  FMUs.SFH_FMU_UFH sFH_FMU_UFH(
  ...
  Modelica.Blocks.Sources.CombiTimeTable table_ts_gains_light(
    ...
    columns=2:2) "Profiles for internal gains" annotation (Placement(
        ...
        rotation=180,
        origin={-157,-41})));
  Modelica.Blocks.Sources.CombiTimeTable table_ts_T_air(
    final tableOnFile=true,
    final smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments,
    final extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    final tableName="ts_T_air",
    final fileName=Modelica.Utilities.Files.loadResource(
        "modelica://MA_Pell_SingleFamilyHouse/Data/ts_T_air.txt"),
    columns=2:2) "Profiles for internal gains" annotation (Placement(
        transformation(
        extent={{7,7},{-7,-7}},
        rotation=180,
        origin={-207,31})));
  Modelica.Blocks.Sources.CombiTimeTable table_ts_win_spe(
    final tableOnFile=true,
    final smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments,
    final extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    final tableName="ts_win_spe",
    final fileName=Modelica.Utilities.Files.loadResource(
        "modelica://MA_Pell_SingleFamilyHouse/Data/ts_win_spe.txt"),
    columns=2:2) "Profiles for internal gains" annotation (Placement(
        transformation(
        extent={{7,7},{-7,-7}},
        rotation=180,
        origin={-183,25})));
  Modelica.Blocks.Sources.CombiTimeTable table_ts_sol_rad(
    final tableOnFile=true,
    final smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments,
    final extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    final tableName="ts_sol_rad",
    final fileName=Modelica.Utilities.Files.loadResource(
        "modelica://MA_Pell_SingleFamilyHouse/Data/ts_sol_rad.txt"),
    columns=2:2) "Profiles for internal gains" annotation (Placement(
        transformation(
        extent={{7,7},{-7,-7}},
        rotation=180,
        origin={-157,21})));
equation
  connect(sFH_FMU_UFH.PV_Distr_Use, table_PV_Distr_Use.y[1]) annotation (Line(
        points={{-36,64.8552},{-172,64.8552},{-172,89},{-181.3,89}}, color={0,0,
          127}));
  connect(table_PV_Distr_FeedIn.y[1], sFH_FMU_UFH.PV_Distr_FeedIn) annotation (
      Line(points={{-181.3,69},{-176,69},{-176,60.8483},{-36,60.8483}}, color={
          0,0,127}));
  connect(table_PV_Distr_ChBat.y[1], sFH_FMU_UFH.PV_Distr_ChBat) annotation (
      Line(points={{-181.3,51},{-116,51},{-116,56.269},{-36,56.269}}, color={0,
          0,127}));
  connect(table_pow_use_BAT.y[1], sFH_FMU_UFH.power_use_BAT) annotation (Line(
        points={{-125.3,79},{-88,79},{-88,51.1172},{-36,51.1172}}, color={0,0,
          127}));
  connect(table_pow_feedIn_BAT.y[1], sFH_FMU_UFH.power_to_grid_BAT) annotation
    (Line(points={{-105.3,89},{-80,89},{-80,45.9655},{-36,45.9655}}, color={0,0,
          127}));
  connect(table_pow_ch_BAT.y[1], sFH_FMU_UFH.ch_BAT) annotation (Line(points={{
          -85.3,95},{-74,95},{-74,41.3862},{-36,41.3862}}, color={0,0,127}));
  connect(table_T_supply_HP_heat.y[1], sFH_FMU_UFH.T_supply_HP_heat)
    annotation (Line(points={{-87.3,-95},{-68,-95},{-68,-56},{-60,-56},{-60,
          -49.6276},{-36,-49.6276}}, color={0,0,127}));
  connect(table_T_supply_cool.y[1], sFH_FMU_UFH.T_supply_cool) annotation (Line(
        points={{-125.3,-119},{-120,-119},{-120,-62},{-86,-62},{-86,-34},{-66,
          -34},{-66,-22.1517},{-36,-22.1517}}, color={0,0,127}));
  connect(table_heat_rod.y[1], sFH_FMU_UFH.heat_rod) annotation (Line(points={{
          -85.3,-115},{-66,-115},{-66,-64},{-58,-64},{-58,-55.3517},{-36,
          -55.3517}}, color={0,0,127}));
  connect(table_ch_DHW.y[1], sFH_FMU_UFH.ch_DHW) annotation (Line(points={{
          -83.3,-155},{-58,-155},{-58,-70},{-36,-70},{-36,-70.2345}}, color={0,
          0,127}));
  connect(table_ch_TES.y[1], sFH_FMU_UFH.ch_TES) annotation (Line(points={{-87.3,
          -135},{-78,-135},{-78,-134},{-62,-134},{-62,-66.8},{-36,-66.8}},
        color={0,0,127}));
  connect(table_x_HP_on.y[1], sFH_FMU_UFH.x_HP_on) annotation (Line(points={{
          -83.3,-177},{-72,-177},{-72,-176},{-60,-176},{-60,-74},{-36,-74},{-36,
          -73.0966}}, color={0,0,127}));
  connect(table_x_HP_heat.y[1], sFH_FMU_UFH.x_HP_heat) annotation (Line(points=
          {{-123.3,-143},{-120,-143},{-120,-144},{-116,-144},{-116,-68},{-76,-68},
          {-76,-29.5931},{-36,-29.5931}}, color={0,0,127}));
  connect(table_x_HP_cool.y[1], sFH_FMU_UFH.x_HP_cool) annotation (Line(points=
          {{-121.3,-167},{-118,-167},{-118,-168},{-112,-168},{-112,-72},{-70,
          -72},{-70,-50},{-60,-50},{-60,-37.0345},{-36,-37.0345}}, color={0,0,
          127}));
  connect(table_T_supply_UFH.y[1], sFH_FMU_UFH.T_supply_UFH) annotation (Line(
        points={{-121.3,-189},{-110,-189},{-110,-78},{-68,-78},{-68,-43.9034},{
          -36,-43.9034}}, color={0,0,127}));
  connect(tableElec.y[1], sFH_FMU_UFH.dem_elec) annotation (Line(points={{
          -179.3,5},{-130,5},{-130,21.3517},{-36,21.3517}}, color={0,0,127}));
  connect(tableEV.y[1], sFH_FMU_UFH.dem_e_mob) annotation (Line(points={{-179.3,
          -15},{-120,-15},{-120,17.3448},{-36,17.3448}}, color={0,0,127}));
  connect(table_dch_TES.y[1], sFH_FMU_UFH.dch_TES) annotation (Line(points={{-177.3,
          -125},{-168,-125},{-168,-102},{-162,-102},{-162,-80},{-36,-80},{-36,-79.3931}},
        color={0,0,127}));
  connect(table_t_TES.y[1], sFH_FMU_UFH.t_TES) annotation (Line(points={{-179.3,
          -145},{-168,-145},{-168,-146},{-158,-146},{-158,-88.5517},{-36,
          -88.5517}}, color={0,0,127}));
  connect(table_t_DHW.y[1], sFH_FMU_UFH.t_DHW) annotation (Line(points={{-179.3,
          -167},{-166,-167},{-166,-168},{-154,-168},{-154,-83.4},{-36,-83.4}},
        color={0,0,127}));
  connect(table_ts_T_inside_max.y[1], sFH_FMU_UFH.ts_T_inside_max) annotation (
      Line(points={{-85.3,-199},{-50,-199},{-50,-95.9931},{-35.5792,-95.9931}},
        color={0,0,127}));
  connect(table_ts_T_inside_min.y[1], sFH_FMU_UFH.ts_T_inside_min) annotation (
      Line(points={{-85.3,-219},{-48,-219},{-48,-107.441},{-35.5792,-107.441}},
        color={0,0,127}));
  connect(table_dem_dhw_T.y[1], sFH_FMU_UFH.dem_dhw_T) annotation (Line(points=
          {{-179.3,-77},{-112,-77},{-112,7.61379},{-36,7.61379}}, color={0,0,
          127}));
  connect(table_dem_dhw_m_flow.y[1], sFH_FMU_UFH.dem_dhw_m_flow) annotation (
      Line(points={{-179.3,-57},{-98,-57},{-98,12.7655},{-36,12.7655}}, color={
          0,0,127}));
  connect(table_ts_gains_light.y[1], sFH_FMU_UFH.ts_gains_light) annotation (
      Line(points={{-149.3,-41},{-92.65,-41},{-92.65,-8.41379},{-36,-8.41379}},
        color={0,0,127}));
  connect(table_ts_gains_dev.y[1], sFH_FMU_UFH.ts_gains_dev) annotation (Line(
        points={{-177.3,-35},{-106.65,-35},{-106.65,-2.11724},{-36,-2.11724}},
        color={0,0,127}));
  connect(table_ts_gains_human.y[1], sFH_FMU_UFH.ts_gains_human) annotation (
      Line(points={{-209.3,-31},{-122.65,-31},{-122.65,2.46207},{-36,2.46207}},
        color={0,0,127}));
  connect(table_ts_T_air.y[1], sFH_FMU_UFH.ts_T_air) annotation (Line(points={{
          -199.3,31},{-117.65,31},{-117.65,37.3793},{-36,37.3793}}, color={0,0,
          127}));
  connect(table_ts_sol_rad.y[1], sFH_FMU_UFH.ts_sol_rad) annotation (Line(
        points={{-149.3,21},{-92.65,21},{-92.65,28.2207},{-36,28.2207}}, color=
          {0,0,127}));
  connect(table_ts_win_spe.y[1], sFH_FMU_UFH.ts_win_spe) annotation (Line(
        points={{-175.3,25},{-110,25},{-110,32.8},{-36,32.8}}, color={0,0,127}));
