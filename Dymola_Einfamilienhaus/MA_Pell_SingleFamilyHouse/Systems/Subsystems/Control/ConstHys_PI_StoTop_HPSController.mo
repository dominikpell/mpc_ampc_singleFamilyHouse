...
model ConstHys_PI_StoTop_HPSController
  ...
  Modelica.Blocks.Logical.Switch switch2 "on: DHW, off: Buffer"
    annotation (Placement(transformation(extent={{-5,-5},{5,5}},
        ...
        origin={5,17})));
equation
  connect(sigBusDistr.T_StoBuf_top, switch2.u3) annotation (Line(
      points={{115.145,-100.785},{-32,-100.785},{-32,6},{9,6},{9,11}},
      color={255,204,51},
      thickness=0.5));
  connect(sigBusDistr.T_StoDHW_top, switch2.u1) annotation (Line(
      points={{115.145,-100.785},{-30,-100.785},{-30,2},{1,2},{1,11}},
      color={255,204,51},
      thickness=0.5));
  connect(switch2.y, HP_nSet_Controller.T_Meas) annotation (Line(points={{5,22.5},
          {5,28},{97,28},{97,61.2}},
                                   color={0,0,127}));
  connect(DHWHysOrLegionella.y, switch2.u2) annotation (Line(points={{-71.25,69},
          {-12,69},{-12,4},{4,4},{4,8},{5,8},{5,11}},          color={255,
          0,255}));
