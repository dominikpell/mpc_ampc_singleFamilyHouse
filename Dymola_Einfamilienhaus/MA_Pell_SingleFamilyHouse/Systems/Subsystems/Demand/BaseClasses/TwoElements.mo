...
model TwoElements
  ...
  extends OneElement(AArray={ATotExt,
        ATotWin,AInt});
  ...
  AixLib.ThermalZones.ReducedOrder.RC.BaseClasses.InteriorWall intWallRC(
    final n=nInt,
    final RInt=RInt,
    final CInt=CInt,
    final T_start=T_IntWall) if AInt > 0 "RC-element for interior walls"
