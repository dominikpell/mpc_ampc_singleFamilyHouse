...
model LookUpTable2D_heat "Performance data coming from manufacturer"
  extends
    AixLib.DataBase.HeatPump.PerformanceData.BaseClasses.PartialPerformanceData;

  parameter Modelica.Blocks.Types.Smoothness smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments
    "Smoothness of table interpolation";
  parameter MA_Pell_SingleFamilyHouse.RecordsCollection.HeatPumpData.HeatPumpCarnotHeat dataTable=
      MA_Pell_SingleFamilyHouse.RecordsCollection.HeatPumpData.HeatPumpCarnotHeat() "Data Table of HP"
  ...
  CombiTable2DExtra Qdot_ConTable(
    final smoothness=smoothness,
    final u1(unit="degC"),
    final u2(unit="degC"),
    final y(unit="W", displayUnit="kW"),
    final extrapolation=false,
    final table=dataTable.tableQdot_con) annotation (extent=[-60,40; -40,60],
      Placement(transformation(
        extent={{-14,-14},{14,14}},
        rotation=-90,
        origin={46,34})));
  CombiTable2DExtra P_eleTable(
    final smoothness=smoothness,
    final extrapolation=false,
    final u1(unit="degC"),
    final u2(unit="degC"),
