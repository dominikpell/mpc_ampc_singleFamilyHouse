...
model LookUpTable2D_cool "Performance data coming from manufacturer"
  extends
    AixLib.DataBase.Chiller.PerformanceData.BaseClasses.PartialPerformanceData;

  parameter Modelica.Blocks.Types.Smoothness smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments
    "Smoothness of table interpolation";
  parameter MA_Pell_SingleFamilyHouse.RecordsCollection.HeatPumpData.HeatPumpCarnotCool dataTable = MA_Pell_SingleFamilyHouse.RecordsCollection.HeatPumpData.HeatPumpCarnotCool()
  ...
  AixLib.Utilities.Tables.CombiTable2DExtra Qdot_EvaTable(
