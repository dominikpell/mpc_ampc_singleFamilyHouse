...
model Test_DistributionBufferModels
  ...
  DistributionTwoBufferStorageParallel
                                 distributionTwoBufferStorageParallel(
    redeclare package MediumDHW = Medium,
    redeclare package MediumBui = Medium,
    redeclare package MediumGen = Medium,
    QHR_flow_nominal=3000,
    redeclare Studies.BuiFlexHP.Data.BufStorage bufParameters,
    redeclare Studies.BuiFlexHP.Data.DHWStorage dhwParameters)
...
equation
  connect(distControlBus, distributionTwoBufferStorageParallel.sigBusDistr)
    annotation (Line(
  ...
  connect(booleanPulse1.y, distControlBus.dhw_on) annotation (Line(points={{-89,54},
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(distributionTwoBufferStorageParallel.portDHW_out,
    artificalPumpFixedT1.port_a) annotation (Line(points={{56,-22.8},{73,-22.8},
          {73,-22},{92,-22}}, color={0,127,255}));
  connect(distributionTwoBufferStorageParallel.portDHW_in, artificalPumpFixedT1.port_b)
  ...
  connect(artificalPumpFixedT2.port_b, distributionTwoBufferStorageParallel.portGen_in)
    annotation (Line(points={{-70,28},{-74,28},{-74,34},{-24,34},{-24,26.2}},
        color={0,127,255}));
  connect(distributionTwoBufferStorageParallel.portGen_out,
    artificalPumpFixedT2.port_a) annotation (Line(points={{-24,6.6},{-50,6.6},{
          -50,8},{-70,8}}, color={0,127,255}));
  connect(m_flow1.y, artificalPumpFixedT2.m_flow_in)
    annotation (Line(points={{-103,12},{-94,12},{-94,18},{-81.6,18}},
                                                    color={0,0,127}));
  connect(distributionTwoBufferStorageParallel.portBui_out,
    distributionTwoBufferStorageParallel.portBui_in) annotation (Line(points={{
          56,26.2},{84,26.2},{84,8},{56,8},{56,6.6}}, color={0,127,255}));
  annotation (experiment(StopTime=31536000, Interval=3600));
end Test_DistributionBufferModels;
