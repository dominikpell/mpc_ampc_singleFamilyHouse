...
model UFHTransferSystem
  ...
  Modelica.Blocks.Sources.RealExpression Q_UFH(y=artificalPumpIsotermhal1[1].m_flow_in
        *systemParameters.c_pWater*(panelHeating[1].TFlow.T - panelHeating[1].TReturn.T))
    annotation (Placement(transformation(extent={{48,-110},{34,-96}})));
protected
...
equation
  ...
  connect(Q_UFH.y, outBusTra.dch_TES) annotation (Line(points={{33.3,-103},{
          13.65,-103},{13.65,-103.95},{0.05,-103.95}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
