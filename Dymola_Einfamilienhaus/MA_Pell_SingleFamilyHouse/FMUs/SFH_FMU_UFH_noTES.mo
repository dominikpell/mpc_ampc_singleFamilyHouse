...
model SFH_FMU_UFH_noTES "Model with UFH transfer system"
  extends Systems.BaseClasses.PartialBuildingEnergySystem(
    ...
    redeclare Systems.Subsystems.Transfer.UFHTransferSystem_noTES
                                                            Transfer(
    ...
    redeclare Systems.Subsystems.Generation.GenerationHeatPumpAndHeatingRod
      ...
      redeclare RecordsCollection.GenerationData.DummyHP heatPumpParameters(
        VEva=0.03,
        VCon=0.03,
        Q_HP_Nom=systemParameters.Q_HP_max),
    ...
    redeclare Systems.Subsystems.Control.Controller_MPC_noTES Control(
        hr_nom_power=parameterStudy.hr_nominal_power),
    redeclare
      Systems.Subsystems.Distribution.DistributionTwoStorageParallel_noTES
      Distribution(
      t_TES=t_TES_Init,
      t_DHW=t_DHW_Init,
 ...
 output Modelica.Blocks.Interfaces.RealOutput Q_DHW
  ...
  Modelica.Blocks.Sources.CombiTimeTable table_ts_price_elec(
    ...
    final fileName=Modelica.Utilities.Files.loadResource(
        "modelica://MA_Pell_SingleFamilyHouse/Data/variable_tariff.txt"),
...
equation
 der(costs_elec) = (outputs.outputsElec.power_from_grid + outputs.outputsElec.power_to_BAT_from_grid)/3600*table_ts_price_elec.y[1]/1000;
