...
record ResidentialBuildingWFloor_SingleDwellingWithFloor
  "ResidentialBuildingWFloor_SingleDwelling with floor area"
  extends AixLib.DataBase.ThermalZones.ZoneBaseRecord(
    ...
    nFloor = 1,
    RFloor = {0.0002318659420585965},
    RFloorRem =  0.015855972702171022,
    CFloor = {8024814.61230118},
    ARoof = 99.75,
    ...
    minAHU = 0.3,
    maxAHU = 0.6,
    hHeat = 6930.362294304516,
    lHeat = 0,
    KRHeat = 10000,
    TNHeat = 1,
    HeaterOn = true,
    hCool = 0,
    lCool = -6930.362294304516,
    KRCool = 10000,
    TNCool = 1,
    CoolerOn = false,
...
end ResidentialBuildingWFloor_SingleDwellingWithFloor;
