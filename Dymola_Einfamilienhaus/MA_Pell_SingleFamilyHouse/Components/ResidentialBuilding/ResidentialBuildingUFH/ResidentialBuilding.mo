...
model ResidentialBuilding
  "This is the simulation model of ResidentialBuilding with traceable ID 0"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    zoneParam={
        ResidentialBuilding_DataBase.ResidentialBuilding_SingleDwellingNoFloor()},
    heatAHU=false,
    coolAHU=false,
    dehuAHU=false,
    huAHU=false,
  ...
  AixLib.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam=Modelica.Utilities.Files.loadResource(
        "modelica://Residential/2018-11-23_WetterdatenHeidelberg.mos"))
    "Weather data reader"
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Residential/ResidentialBuilding/InternalGains_ResidentialBuilding.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Residential/ResidentialBuilding/AHU_ResidentialBuilding.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Residential/ResidentialBuilding/TsetHeat_ResidentialBuilding.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://Residential/ResidentialBuilding/TsetCool_ResidentialBuilding.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/ResidentialBuilding/ResidentialBuilding.mos"
      "Simulate and Plot"),
