within MA_Pell_SingleFamilyHouse.Components.UFH;
model PanelHeating
  "A panel heating for e.g. floor heating with discretization"
  parameter Real T_thermalCapacity_top=298.15 annotation(Dialog(tab="Initialize"));
  parameter Real T_thermalCapacity_down=298.15 annotation(Dialog(tab="Initialize"));

  extends Modelica.Fluid.Interfaces.PartialTwoPort;

  replaceable parameter
    MA_Pell_SingleFamilyHouse.Components.UFH.ActiveWallBaseDataDefinition floorHeatingType
    constrainedby
    MA_Pell_SingleFamilyHouse.Components.UFH.ActiveWallBaseDataDefinition
