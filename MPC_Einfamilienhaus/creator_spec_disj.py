...
class Creator:
    def __init__(self, options, start_time, control_horizon, prediction_horizon, time_step, year, hour_of_year, parameters, devs, initials):
    ...
    def create_model(self, model):
        ...
        self.k_HE = 450  # W/m²K
        self.A_HE = 2  # m²
        self.estimator_dT_TES = 3
        self.estimator_dT_DHW = 6
        self.T_basement = 273.15 + 18
        ...
        model.ts_price_el = Param(model.time_steps, mutable=True)
        ...
        model.power_HP = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_HP")
        model.power_HP_heat = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_HP_heat")
        model.power_HP_cool = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_HP_cool")
        model.power_rod = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_rod")
        model.power_PV = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_PV")
        model.power_to_grid = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_to_grid")
        model.power_from_grid = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_from_grid")
        model.E_from_grid = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="E_from_grid")
        model.E_to_grid = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="E_to_grid")
        model.power_use_PV = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_use_PV")
        model.PV_Distr_Use = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="PV_Distr_Use")
        model.PV_Distr_FeedIn = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="PV_Distr_FeedIn")
        model.PV_Distr_ChBat = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="PV_Distr_ChBat")
        model.power_use_BAT = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_use_BAT")
        model.power_to_grid_PV = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_to_grid_PV")
        model.power_to_grid_BAT = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_to_grid_BAT")
        model.power_to_BAT_PV = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="power_to_BAT_PV")
        model.power_to_BAT_from_grid = Var(model.time_steps, initialize=0, bounds=(0, 100000),
                                           name="power_to_BAT_from_grid")

        # HP
        model.COP_HP_heat = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="COP_HP_heat")
        model.COP_HP_cool = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="COP_HP_cool")
        model.x_HP_on = Var(model.time_steps, within=Binary, name='x_HP_on')
        ...
        model.cool_HP = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="cool_HP")
        model.heat_HP = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="heat_HP")
        model.T_supply = Var(model.time_steps, initialize=290, bounds=(280, 400), name="T_supply")
        model.T_return = Var(model.time_steps, initialize=290, bounds=(280, 400), name="T_return")
        model.T_supply_HP_heat = Var(model.time_steps, initialize=290, bounds=(280, 400), name="T_supply_HP_heat")
        model.T_supply_heat = Var(model.time_steps, initialize=290, bounds=(280, 350), name="T_supply_heat")
        ...
        model.T_supply_cool = Var(model.time_steps, initialize=290, bounds=(280, 400), name="T_supply_cool")
        ...
        # Heating Rod
        model.heat_rod = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="heat_rod")
        ...
        # Storage devices
        # model.T_lay4_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_lay4_TES")
        # model.T_lay3_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_lay3_TES")
        # model.T_lay2_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_lay2_TES")
        # model.T_lay1_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_lay1_TES")
        # model.T_layHE4_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_layHE4_TES")
        # model.T_layHE3_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_layHE3_TES")
        # model.T_layHE2_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_layHE2_TES")
        # model.T_layHE1_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_layHE1_TES")

        # model.Q_he4_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_he4_TES")
        # model.Q_loss4_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_loss4_TES")
        # model.Q_34_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_34_TES")
        # model.Q_he3_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_he3_TES")
        # model.Q_loss3_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_loss3_TES")
        # model.Q_23_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_23_TES")
        # model.Q_he2_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_he2_TES")
        # model.Q_loss2_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_loss2_TES")
        # model.Q_12_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_12_TES")
        # model.Q_he1_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_he1_TES")
        # model.Q_loss1_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="Q_loss1_TES")

        # model.T_lay4_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_lay4_DHW")
        # model.T_lay3_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_lay3_DHW")
        # model.T_lay2_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_lay2_DHW")
        # model.T_lay1_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_lay1_DHW")
        # model.T_layHE4_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_layHE4_DHW")
        # model.T_layHE3_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_layHE3_DHW")
        # model.T_layHE2_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_layHE2_DHW")
        # model.T_layHE1_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="T_layHE1_DHW")

        # model.Q_he4_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_he4_DHW")
        # model.Q_loss4_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_loss4_DHW")
        # model.Q_34_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_34_DHW")
        # model.Q_he3_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_he3_DHW")
        # model.Q_loss3_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_loss3_DHW")
        # model.Q_23_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_23_DHW")
        # model.Q_he2_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_he2_DHW")
        # model.Q_loss2_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_loss2_DHW")
        # model.Q_12_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_12_DHW")
        # model.Q_he1_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_he1_DHW")
        # model.Q_loss1_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="Q_loss1_DHW")
        ...
        model.ch_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="ch_TES")
        model.dch_TES = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="dch_TES")
        model.t_TES = Var(model.time_steps, initialize=290,
                          bounds=(self.devs["TES"]["t_min"], self.devs["TES"]["t_max"]),
                          name="t_TES")  # Average Temperature of TES
        model.t_Pinch_TES = Var(model.time_steps, initialize=2, bounds=(-100000, 100000), name="t_Pinch_ch_TES_heat")
        model.heat_loss_TES = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="heat_loss_TES")
        ...
        model.ch_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="ch_DHW")
        model.dch_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="dch_DHW")
        model.t_DHW = Var(model.time_steps, initialize=290,
                          bounds=(self.devs["DHW"]["t_min"], self.devs["DHW"]["t_max"]),
                          name="t_DHW")  # Average Temperature of DHW
        model.t_Pinch_DHW = Var(model.time_steps, initialize=2, bounds=(-100000, 100000), name="t_Pinch_DHW")
        model.heat_loss_DHW = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="heat_loss_DHW")
        ...
        model.ch_BAT = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="ch_BAT")
        model.dch_BAT = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="dch_BAT")
        model.energy_BAT = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="energy_BAT")

        # residual loads
        model.res_elec = Var(model.time_steps, initialize=0, bounds=(-100000, 100000), name="residual_electricity_demand")
        # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        """ Add constraints """
        ...
        @model.Constraint(model.time_steps)
        def HP_on_rule(m, t):
            return (m.x_HP_on[t] == m.x_HP_heat[t] + m.x_HP_cool[t])  # Either Heating or Cooling with HP

        @model.Constraint(model.time_steps)
        def Bin_ch_TES_or_DHW_rule(m, t):
            return (m.x_TES_ch[t] + m.x_DHW_ch[t] == m.x_HP_on[t])  # if heat pump is active, either charge TES or DHW
        ...
        def Lim_heat_HP_rule2(m, t):
            return (m.heat_HP[t] >= m.x_HP_heat[t]*100)  # Minimum
        ...
        def Lim_cool_HP_rule2(m, t):
            return (m.cool_HP[t] >= m.x_HP_cool[t]*100)  # Minimum

        # Heating Rod
        @model.Constraint(model.time_steps)
        def Lim_cap_rod_rule(m, t):
            return (m.heat_rod[t] <= self.devs["rod"]["cap"])  # Limits Power of the heating rod
        ...
        def EB_HP_cool_rule(m, t):
            return (m.cool_HP[t] == self.m_flow_nominal_HP * self.parameters["c_f"] * (m.T_return_cool[t] - m.T_supply_cool[t]))
        ...
        @model.Constraint(model.time_steps)
        def UFH_supply_rule1(m, t):
            return ((m.t_TES[t] + self.estimator_dT_TES) - m.T_supply_UFH[t] >= 0)  # Ensures that TES is hot enough

        @model.Constraint(model.time_steps)
        def UFH_supply_rule2(m, t):
            return (m.T_supply_UFH[t] - (m.t_TES[t] - self.estimator_dT_TES) >= 0)  # Ensures that TES is cold enough

        @model.Constraint(model.time_steps)
        def loss_TES_rule(m, t):
            return (m.heat_loss_TES[t] == (m.t_TES[t] - self.T_basement)
        ...
        #     return (m.T_supply_heat[t] - (m.t_DHW[t] + 1 / 2 * (self.devs["DHW"]["t_max"] - m.t_DHW[t])) >= 2 - (
        #                 1 - m.x_DHW_ch[t]) * 100)  # Pinch Upper Layer
        #
        # @model.Constraint(model.time_steps)
        # def Pinch_low_ch_DHW_rule(m, t):
        #     return (m.T_return_heat[t] - (m.t_DHW[t] - 1 / 2 * (m.t_DHW[t] - self.devs["DHW"]["t_min"])) >= 2 - (
        #                 1 - m.x_DHW_ch[t]) * 100)  # Pinch Lower Layer

        @model.Constraint(model.time_steps)
        def Pinch_top_ch_DHW_rule(m, t):
            return (m.T_supply_heat[t] - (m.t_DHW[t] + 2) >= 2 - (1 - m.x_DHW_ch[
                t]) * 100)  # Pinch Upper Layer, 2K in first term is approx. temp difference between avg and top/bot layer

        @model.Constraint(model.time_steps)
        def Pinch_low_ch_DHW_rule(m, t):
            return (m.T_return_heat[t] - (m.t_DHW[t] - 2) >= 2 - (1 - m.x_DHW_ch[
                t]) * 100)  # Pinch Lower Layer, 2K in first term is approx. temp difference between avg and top/bot layer

        @model.Constraint(model.time_steps)
        def T_dch_DHW_rule(m, t):
            return ((m.t_DHW[t] + self.estimator_dT_DHW) >= m.dem_dhw_T[t])  # Ensures that DHW is hot enough

        @model.Constraint(model.time_steps)
        def EB_dch_DHW2_rule(m, t):
            return (m.dch_DHW[t] == m.dem_dhw_m_flow[t] * self.parameters["c_f"] * (
                        m.dem_dhw_T[t] - self.devs["DHW"]["t_min"]))  # Discharge Heat Flow

        @model.Constraint(model.time_steps)
        def loss_DHW_rule(m, t):
            return (m.heat_loss_DHW[t] == (m.t_DHW[t] - self.T_basement)
                                           * self.devs["DHW"]["k_loss"] * self.devs["DHW"]["vol"] / 1000
                                           * self.parameters["c_f"] * self.parameters["rho"] / 3600)

        @model.Constraint(model.time_steps)
        def SOC_DHW_rule(m, t):
            return (m.soc_DHW[t] == (m.t_DHW[t] - self.devs["DHW"]["t_min"]) / (
                        self.devs["DHW"]["t_max"] - self.devs["DHW"]["t_min"]))  # State of Charge

        @model.Constraint(model.time_steps)
        def T_min_DHW_rule(m, t):
            return (m.t_DHW[t] >= m.dem_dhw_m_flow[t])  # To overcome low temperature problem because of averaged dem_dhw_T
        ...
        if np.mean(get_params.get_T_air_forecast(self.prediction_horizon, self.time_step, self.year,
                                                 self.hour_of_year)) <= 273.15 + 12:
        ...
        T_supply_points, COP_points = get_COP.LinReg_heat(self.devs["HP"]["eta_COP"], T_supply_min, T_supply_max,
                                                          T_heat_min, T_heat_max)
        xbreaks = np.array([[np.interp(t, T_supply_points[:, 0], T_supply_points[:, l]) for l in range(1, 4)] for t in
                            get_params.get_T_air_forecast(self.prediction_horizon, self.time_step, self.year,
                                                          self.hour_of_year)])
        x_breaks = dict(enumerate(xbreaks.tolist()))
        ybreaks = np.array([[np.interp(t, COP_points[:, 0], COP_points[:, l]) for l in range(1, 4)] for t in
                            get_params.get_T_air_forecast(self.prediction_horizon, self.time_step, self.year,
                                                          self.hour_of_year)])
        y_breaks = dict(enumerate(ybreaks.tolist()))
        # Get COP from PWL relation
        model.pwl_COP1 = Piecewise(model.time_steps, model.COP_HP_heat, model.T_supply_HP_heat, pw_pts=x_breaks,
                                   pw_constr_type='EQ', f_rule=y_breaks, pw_repn='SOS2', name="pwlCOP1", warn_domain_coverage=False)
        ...
        T_supply_points, COP_points = get_COP.LinReg_cool(self.devs["HP"]["eta_COP"], T_supply_min, T_supply_max,
                                                          T_heat_min, T_heat_max)
        xbreaks = np.array([[np.interp(t, T_supply_points[:, 0], T_supply_points[:, l]) for l in range(1, 4)] for t in
                            get_params.get_T_air_forecast(self.prediction_horizon, self.time_step, self.year,
                                                          self.hour_of_year)])
        ...
        # Get COP from PWL relation
        model.pwl_COP2 = Piecewise(model.time_steps, model.COP_HP_cool, model.T_supply_cool, pw_pts=x_breaks,
                                   pw_constr_type='EQ', f_rule=y_breaks, pw_repn='SOS2', name="pwlCOP2", warn_domain_coverage=False)
        ...
        model.asos_c_heat = Var(x_int[1:], model.time_steps, bounds=(0.0, 1.0), name="asos_c_heat")
        ...
        model.gsos_c_heat = Var(y_int[:-1], model.time_steps, bounds=(0.0, 1.0), name="gsos_c_heat")
        ...
        @model.Constraint(model.time_steps)
        def pwl_rule23(m, t):
            return (m.power_HP_heat[t] == sum(
                m.bsos_b_heat[j, t] * y_bp[j] + m.gsos_c_heat[j, t] * (y_bp[j + 1] - y_bp[j]) for j in y_int[:-1]))
        ...
        # SOS2 type: two variables > 0 that give the proportion of breakpoints
        model.asos_c_cool = Var(x_int[1:], model.time_steps, bounds=(0.0, 1.0), name="asos_c_cool")
        # Binary that marks the active Interval x
        model.hsos_b_cool = Var(x_int, model.time_steps, within=Binary, name="hsos_b_cool")
        # SOS1 type: Relative position of Y on Interval y
        model.gsos_c_cool = Var(y_int[:-1], model.time_steps, bounds=(0.0, 1.0), name="gsos_c_cool")
        # Binary that marks the active Interval y
        ...
        @model.Constraint(model.time_steps)
        def EB_PV0(m, t):
            return (m.ts_powerPV[t] == m.power_PV[t])

        @model.Constraint(model.time_steps)
        def EB_PV1(m, t):
            return (m.power_PV[t] == m.power_use_PV[t] + m.power_to_grid_PV[t] + m.power_to_BAT_PV[t])
        ...
        @model.Constraint(model.time_steps)
        def EB_Grid1(m, t):
            return (m.power_from_grid[t] <= self.parameters["grid_limit_el"])
        @model.Constraint(model.time_steps)
        def EB_Grid2(m, t):
            return (m.power_to_grid[t] <= self.parameters["grid_limit_el"])
        ...
        @model.Constraint(model.time_steps)
        def EB_Elec8(m, t):
            return (m.E_from_grid[t] == self.time_step * (m.power_from_grid[t] + m.power_to_BAT_from_grid[t]))

        @model.Constraint(model.time_steps)
        def EB_Elec9(m, t):
            return (m.E_to_grid[t] == self.time_step * m.power_to_grid[t])
    ...
    def create_tz(self, model):
        ...
        model.dT_vio = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="dT_vio")
        ...
        def dT_vio_rule(m, t):
            return (m.dT_vio[t] == m.eps_Air_pos[t] + m.eps_Air_neg[t])
        model.dT_vio_rule = Constraint(model.time_steps, rule=dT_vio_rule)
    ...
    def create_ufh(self, model):
        ...
        model.hCon = Var(model.time_steps, initialize=0, bounds=(0, 100000), name="hCon")
    ...
    def add_disjuncts_hps(self, model):
        """
        ...
        # UFH modes: UFH is cooling, UFH is heating
        def UFH_cool(disj, t):
            model = disj.model()
            # disj.UFH_cool_1 = Constraint(expr=model.T_return_UFH[t] >= model.T_supply_UFH[t])
            # disj.UFH_cool_2 = Constraint(expr=model.T_return_UFH[t] - model.T_supply_UFH[t] <= 10)
            disj.UFH_cool_2 = Constraint(expr=model.T_panel_heating1[t] <= model.T_Air[t])
            disj.UFH_cool_3 = Constraint(expr=model.Q_conv_UFH[t] == 0.7 * self.A * (model.T_panel_heating1[t] - model.T_Air[t]))
        model.UFH_cool = Disjunct(model.time_steps, rule=UFH_cool)

        def UFH_heat(disj, t):
            model = disj.model()
            # disj.UFH_heat_1 = Constraint(expr=model.T_supply_UFH[t] >= model.T_return_UFH[t])
            # disj.UFH_heat_2 = Constraint(expr=model.T_supply_UFH[t] - model.T_return_UFH[t] <= 10)
            disj.UFH_heat_2 = Constraint(expr=model.T_panel_heating1[t] >= model.T_Air[t])
            disj.UFH_heat_3 = Constraint(expr=model.Q_conv_UFH[t] == 5 * self.A * (model.T_panel_heating1[t] - model.T_Air[t]))
        model.UFH_heat = Disjunct(model.time_steps, rule=UFH_heat)

        def HP_heat(disj, t):
            model = disj.model()
            disj.HP_disj_1 = Constraint(expr=model.T_supply_HP_heat[t] >= (25 + 273.15) * model.x_HP_heat[t] + (1-model.x_HP_heat[t]) * 250)
            disj.HP_disj_2 = Constraint(expr=model.T_supply_HP_heat[t] <= (45 + 273.15) * model.x_HP_heat[t] + (1-model.x_HP_heat[t]) * 350)
            disj.HP_disj_3 = Constraint(expr=model.T_return_heat[t] <= model.T_supply_HP_heat[t])
            disj.HP_disj_4 = Constraint(expr=model.ch_TES[t] >= 0)
            disj.HP_disj_5 = Constraint(expr=model.power_rod[t] >= 0)
            disj.HP_disj_6 = Constraint(expr=model.T_supply_heat[t] - (model.t_TES[t]+self.estimator_dT_TES) >= 2 - (1-model.x_TES_ch[t]) * 100)  # Pinch Lower layer
            disj.HP_disj_7 = Constraint(expr=model.T_return_heat[t] - (model.t_TES[t]-self.estimator_dT_TES) >= 2 - (1-model.x_TES_ch[t]) * 100)  # Pinch Upper layer
            disj.HP_disj_8 = Constraint(expr=model.x_HP_cool[t] == 0)
            disj.HP_disj_9 = Constraint(expr=model.T_supply[t] == model.T_supply_heat[t])
            disj.HP_disj_10 = Constraint(expr=model.T_return[t] == model.T_return_heat[t])

        model.HP_heat = Disjunct(model.time_steps, rule=HP_heat)

        def HP_cool(disj, t):
            model = disj.model()
            disj.HP_disj_1 = Constraint(expr=model.T_supply_cool[t] >= (15 + 273.15) * model.x_HP_cool[t] + (1-model.x_HP_cool[t]) * 250)
            disj.HP_disj_2 = Constraint(expr=model.T_supply_cool[t] <= (25 + 273.15) * model.x_HP_cool[t] + (1-model.x_HP_cool[t]) * 350)
            disj.HP_disj_3 = Constraint(expr=model.T_return_cool[t] >= model.T_supply_cool[t])
            disj.HP_disj_4 = Constraint(expr=model.ch_TES[t] <= 0)
            disj.HP_disj_5 = Constraint(expr=model.power_rod[t] == 0)
            disj.HP_disj_6 = Constraint(expr=model.T_supply_cool[t] - (model.t_TES[t]-self.estimator_dT_TES) <= -2 + (1-model.x_TES_ch[t]) * 100)  # Pinch Lower layer
            disj.HP_disj_7 = Constraint(expr=model.T_return_cool[t] - (model.t_TES[t]+self.estimator_dT_TES) <= -2 + (1-model.x_TES_ch[t]) * 100)  # Pinch Upper layer
            disj.HP_disj_8 = Constraint(expr=model.x_HP_heat[t] == 0)
            disj.HP_disj_9 = Constraint(expr=model.T_supply[t] == model.T_supply_cool[t])
            disj.HP_disj_10 = Constraint(expr=model.T_return[t] == model.T_return_cool[t])
        model.HP_cool = Disjunct(model.time_steps, rule=HP_cool)

        def UFH_modes(model, t):
            return [model.UFH_heat[t], model.UFH_cool[t]]

        def HP_modes(model, t):
            return [model.HP_heat[t], model.HP_cool[t]]

        model.UFH_modes = Disjunction(model.time_steps, rule=UFH_modes)
        model.HP_modes = Disjunction(model.time_steps, rule=HP_modes)
        return model
    ...
    def get_control(self, demand, time_series):
        ...
        # define time-varying constraints, initials and scenario based equations
        def _init(instance):
            ...
            # yield instance.T_supply[0] == self.initials["T_supply"]
            if self.initials["T_supply_UFH"] >= (self.initials["t_TES"] + self.estimator_dT_TES):
                yield instance.T_supply_UFH[0] == (self.initials["t_TES"] + self.estimator_dT_TES)
            elif self.initials["T_supply_UFH"] <= (self.initials["t_TES"] - self.estimator_dT_TES):
                yield instance.T_supply_UFH[0] == (self.initials["t_TES"] - self.estimator_dT_TES)
            else:
            ...
            if self.initials["soc_BAT"] <= self.devs["BAT"]["SOC_min"]:
                yield instance.soc_BAT[0] == self.devs["BAT"]["SOC_min"]
            else:
                yield instance.soc_BAT[0] == self.initials["soc_BAT"]

            # if np.mean(time_series["ts_T_air"]) <= 273.15 + 12: # HP does not need to cool
            #     for t in np.arange(0, len(instance.time_steps)):
            #         yield instance.x_HP_cool[t] == 0


            # define scenario based equations
            for t in np.arange(0, len(instance.time_steps)):
                # equations for HP heating mode
                yield (instance.T_supply_HP_heat[t] >= (25 + 273.15) * instance.x_HP_heat[t] + (1-instance.x_HP_heat[t]) * 250)
                yield (instance.T_supply_HP_heat[t] <= (55 + 273.15) * instance.x_HP_heat[t] + (1-instance.x_HP_heat[t]) * 350)
                yield (instance.T_return_heat[t] <= instance.T_supply_HP_heat[t])
                yield (instance.ch_TES[t] >= 0)
                yield (instance.T_supply[t] - (instance.t_TES[t]+self.estimator_dT_TES) >= 2 - (1-instance.x_TES_ch[t]) * 100)  # Pinch Lower layer
                yield (instance.T_return[t] - (instance.t_TES[t]-self.estimator_dT_TES) >= 2 - (1-instance.x_TES_ch[t]) * 100)  # Pinch Upper layer
                yield (instance.x_HP_cool[t] == 0)
                yield (instance.T_supply[t] == instance.T_supply_heat[t])
                yield (instance.T_return[t] == instance.T_return_heat[t])

                # equations for UFH heating mode
                ...
                # # equations for HP cooling mode
                # yield (instance.T_supply_cool[t] >= (15 + 273.15) * instance.x_HP_cool[t] + (1-instance.x_HP_cool[t]) * 250)
                # yield (instance.T_supply_cool[t] <= (25 + 273.15) * instance.x_HP_cool[t] + (1-instance.x_HP_cool[t]) * 350)
                # yield (instance.T_return_cool[t] >= instance.T_supply_cool[t])
                # yield (instance.ch_TES[t] <= 0)
                # yield (instance.power_rod[t] == 0)
                # yield ((instance.t_TES[t]-self.estimator_dT_TES) - instance.T_supply_cool[t] >= 2 - (1-instance.x_TES_ch[t]) * 100)  # Pinch Lower layer
                # yield ((instance.t_TES[t]+self.estimator_dT_TES) - instance.T_return_cool[t] >= 2 - (1-instance.x_TES_ch[t]) * 100)  # Pinch Upper layer
                # yield (instance.x_HP_heat[t] == 0)
                # yield (instance.T_supply[t] == instance.T_supply_cool[t])
                # yield (instance.T_return[t] == instance.T_return_cool[t])
                #
                # # equations for UFH cooling mode
                # yield (instance.T_supply_UFH[t] <= instance.T_return_UFH[t])
                # yield (instance.T_return_UFH[t] - instance.T_supply_UFH[t] <= 10)
        ...
        dir_log_file = os.path.join(path_file, "Results", "DATA", "logfile.log")
        sol = opt.solve(instance, tee=True, keepfiles=True, logfile= dir_log_file, options_string = solver_parameters)
        results = {}
        if (sol.solver.termination_condition == TerminationCondition.infeasibleOrUnbounded):
            print("CHECK")
        if (sol.solver.status == SolverStatus.ok) and (sol.solver.termination_condition == TerminationCondition.optimal):
            sol_time = sol.solver.wallclock_time
            ...
            for key in ["tot_vio_Kh", "costs_tot", "costs_vio", "costs_elec", "rev_elec"]:
                results[key] = []

            for t in range(int(self.prediction_horizon/self.time_step)):
                results["tot_vio_Kh"].append(self.time_step * value(instance.dT_vio[t]))
                results["costs_vio"].append(self.parameters["price_comfort_vio"] * self.time_step * value(instance.dT_vio[t]**2))
                results["costs_elec"].append(value(instance.ts_price_el[t]) * self.time_step * (value(instance.power_from_grid[t]) + value(instance.power_to_BAT_from_grid[t])))
                results["rev_elec"].append(self.parameters["feed_in_revenue_el"] * self.time_step * value(instance.power_to_grid[t]))
                results["costs_tot"].append(results["costs_vio"][t] + results["costs_elec"][t] - results["rev_elec"][t])

            results["Q_DHW"] = []
            results["Q_err_DHW"] = []
            for t in range(int(self.prediction_horizon / self.time_step)):
                results["Q_DHW"].append(self.time_step * results["dem_dhw_m_flow"][t] * self.parameters["c_f"] * (results["dem_dhw_T"][t] - 283.15)/1000)
                results["Q_err_DHW"].append(0)
            ...
            return results, instance, sol, sol_time
    ...
    def create_obj(self, instance):
        ...
        @instance.Constraint()
        def EB_Elec5(m):
            return (m.el_costs == self.time_step * sum(instance.ts_price_el[t] * (m.power_from_grid[t] + m.power_to_BAT_from_grid[t]) for t in instance.time_steps))
